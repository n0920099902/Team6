	...
	<div class="register-photo">
		<div class="form-container">
			...
			<form action="${contextRoot}/member/sign" method="POST"
				...
				<div>
					會員帳號： <input type="text" name="mAccount" id="mAccount" required>
				</div>
				<div>
					會員密碼： <input type="password" name="mPassword" id="mPassword"
						required>
				</div>
				<div>
					會員信箱： <input type="email" name="mEmail" id="mEmail" required>
				</div>
				<div>
					會員電話： <input type="text" id="mPhone" name="mPhone" id="mPhone"
						onblur="ckPhone()" onfocus="defaultPhoneOut()" required><span
						style="color: red" id="phoneout"></span>
				</div>
				<div>
					會員生日： <input type="date" name="mBirthday" id="mBirthday" required>
				</div>
				<div>
					<!-- 			權限 -->
