...
<body>
	...
	<nav class="navbar navbar-expand-xl navbar-dark bg-dark">
		...
		<ul class="navbar-nav mr-auto">
			...
			<%-- 					href="${contextRoot}/restaurant"><h5>主頁</h5></a></li> --%>
			<!-- 				<li class="nav-item"><a class="nav-link" -->
			...
			<!-- 					<li class="nav-item"><a class="nav-link" -->
			<%-- 						href="${contextRoot}/backend/dish/category"><h5>編輯商品種類</h5> </a></li> --%>
			<%-- 				</c:if> --%>
			<!-- 				<li class="nav-item"><a class="nav-link" -->
			<%-- 					href="${contextRoot}/GM">後台管理</a></li> --%>
		...
		<div class="nav-item dropdown fixed-bottom-end ">
			...
			<!-- 				<div class="container" -->
			<!-- 					style="margin-right: 0px; padding-left: 0px; padding-right: 0px; margin-left: 80%;"> -->
