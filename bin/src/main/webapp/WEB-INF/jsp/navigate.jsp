...
<!-- 			<!-- 導覽選項 --> -->
<!-- 			<ul -->
<!-- 				class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0"> 水平對齊 -->
<%-- 				<li><a href="${pageContext.request.contextPath}" --%>
<!-- 					class="nav-link px-2 link-secondary">筆電專賣店</a></li> -->
<!-- 				<li><a -->
...
<%-- 				<li><a href="${pageContext.request.contextPath}/ListAllProducts.do" --%>
...
<!-- 			<!-- 會員登入/登入成功圖案 --> -->
<!-- 			<div class="dropdown text-end"> 看不懂 -->
...
<%-- 						<span>${users.name }</span>  <!-- 資料庫photo資料類型為varbinary(MAX) --> --%>
